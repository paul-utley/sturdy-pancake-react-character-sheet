      ...
      {isMobileScreen ? (
        <div className="mobile-layout">
          <div className="mobile-tabs">
            <button 
              className={`mobile-tab ${activeMobileTab === 'character' ? 'active' : ''}`}
              onClick={() => setActiveMobileTab('character')}
            >
              Core
            </button>
            <button 
              className={`mobile-tab ${activeMobileTab === 'abilities' ? 'active' : ''}`}
              onClick={() => setActiveMobileTab('abilities')}
            >
              Abilities
            </button>
            <button 
              className={`mobile-tab ${activeMobileTab === 'combat' ? 'active' : ''}`}
              onClick={() => setActiveMobileTab('combat')}
            >
              Combat
            </button>
            <button 
              className={`mobile-tab ${activeMobileTab === 'stats' ? 'active' : ''}`}
                  ...
                  {(character.abilities || []).map((ability, index) => {
                    ...
                    return (
                      <div key={ability.id} className="ability-card">
                        <DynamicListItem key={ability.id} onRemove={() => handleAbilitiesChange(character.abilities.filter((a, i) => i !== index))} isLocked={isLocked}>
                          <TabbedTextarea 
                            item={ability} 
